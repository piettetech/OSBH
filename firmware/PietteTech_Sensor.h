...
#ifndef _PIETTETECH_SENSOR_H
#define _PIETTETECH_SENSOR_H
...
class PietteTech_Sensor {
 public:
  // Constructor(s)
  void constructor();

  // Serial.print methods
  void printSensorDetail(sensor_t *sensor);
  void printSensorEvent(sensors_event_t* event, char* name = NULL);
  void printSensorUnits(uint32_t sensor_type, bool nl = false);
  void printSensorType(uint32_t sensor_type, bool nl = false);
